...
<script>
	$(document).ready(function() {
		...
		$("[value=Transfer]").click(function(){
			var fromAccNumber = $("[name=fromAccountNumber").val();
			var toAccNumber = $("[name=toAccountNumber").val();
			var amount = $("[name=transferAmount").val();
			alert("Confirm transfer of " +amount +" from: " +fromAccNumber+" to: "+ toAccNumber);
		})
	});
</script>
</head>
...
<body class="d-flex flex-column min-vh-100">
	...
	<div style="position: absolute; left: 50%; top: 190px">
		<button id="transferButton"style="width: 250px;" class="btn btn-outline-success">Transfer Funds</button>
		<div id="transfer" style="display:none">
			<br>
			<form action="${pageContext.request.contextPath}/accounts/transfer"
				method="GET">
				Debit Account: <input type="text" class="form-control" placeholder="Debit Account" name="fromAccountNumber" /><br>
				Credit Account: <input type="text" class="form-control" placeholder="Credit Account" name="toAccountNumber" /><br>
				Amount: <input type="text" class="form-control" placeholder="Amount" name="Amount" /><br> 
				<input type="submit" class="btn btn-outline-primary" value="Transfer">
			</form>
		</div>
