...
<script>
	$(document).ready(function() {
		...
		$("[value=Credit]").click(function(){
			var accNumber = $("#creditAccountNumber").val();
			var amount = $("#creditAmount").val();
			alert("Confirm credit of " +amount +" to: " +accNumber);
		})
	});
</script>
</head>
...
<body class="d-flex flex-column min-vh-100">
	...
	<div style="position: absolute; left: 50%; top: 190px">
		<button id="creditButton" style="width: 250px;" class="btn btn-outline-success">Credit to account</button>
		<div id="credit" style="display:none">
			<br>
			<form action="${pageContext.request.contextPath}/accounts/credit"
				method="GET">
				To Account: <input type="text" class="form-control" placeholder="To Account" name="AccountNumber" id ="creditAccountNumber" /><br>
				Amount: <input type="text" class="form-control" placeholder="Amount" name="Amount" id = "creditAmount"/><br> 
				<input type="submit" class="form-control btn btn-outline-primary" value="Credit">
			</form>
		</div>
